...
//				'width'			: $cfs.css('width'),
		...
		$cfs._cfs_bind_events = function() {
			...
			$cfs.bind(cf_e('slide_next', conf), function(e, sO, nI) {
				...
				//	save new sizes
				var i_siz = ms_getTotalSize(a_itm.slice(0, nI), opts, 'width'),
					w_siz = cf_mapWrapperSizes2(ms_getSizes(c_new, opts, true), opts, !opts.usePadding);
  ...
  */
	...
	function sz_setSizes($c, o, p) {
		var $w = $c.parent(),
			...
			sz = cf_mapWrapperSizes2(ms_getSizes($v, o, true), o, p);
    ...
    function cf_mapWrapperSizes2(ws, o, p) {
        if (typeof p != 'boolean') p = true;
        var pad = (o.usePadding && p) ? o.padding : [0, 0, 0, 0];
        var wra = {};
// youtube fix
